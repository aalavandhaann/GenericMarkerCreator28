...
def getDuplicatedObject(context, meshobject, meshname="Duplicated", wire = False):
        ...
        meshobject.hide_viewport = hide_view;
...
def getBMMesh(context, obj, useeditmode = False):
    if(not useeditmode):
