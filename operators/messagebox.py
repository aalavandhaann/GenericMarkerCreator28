...
class GenericLandmarksConfirmationBox(bpy.types.Operator):
    bl_idname = "genericlandmarks.confirmationbox"# unique identifier for buttons and menu items to reference.
    ...
    def draw(self, context):
        ...
        self.layout.prop(self, "confirmation", expand=True)
