...
updater.addon = "genericlandmarks"
...
def register(bl_info):
    ...
    updater.user = "aalavandhaann"

    # Choose your own repository, must match git name for GitHUb and Bitbucket,
    # for GitLab use project ID (numbers only).
    updater.repo = "GenericMarkerCreator28"

    # updater.addon = # define at top of module, MUST be done first

    # Website for manual addon download, optional but recommended to set.
    updater.website = "https://github.com/aalavandhaann/GenericMarkerCreator28"
    ...
    for cls in classes:
        ...
        try:
            ...
            print(cls, ' HAS BEEN ALREADY REGISTERED')
...
def unregister():
    for cls in reversed(classes):
        ...
        try:
            ...
            print(cls.__class__, ' CANNOT BE UNREGISTRED OR IS ALREADY UREGISTERED')
