...
def register():
    ...
    from GenericMarkerCreator28.operators.landmarkscreator import UnLinkLandmarks, LinkLandmarks, RemoveLandmarks;

    classes_key_mappings = [
        (AssignMeshPair, 'A', True, True), 
        (LiveLandmarksCreator, 'M', True, True), 
        (LinkLandmarks, 'SLASH', False, False), 
        (UnLinkLandmarks, 'PERIOD', False, False), 
